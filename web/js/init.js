...
var NOTIFY = new Audio("sounds/notify.wav"); // buffers automatically when created
var DRINK = new Audio("sounds/drink.wav"); // buffers automatically when created
var ATTENTION = new Audio("sounds/attention.wav"); // [](/shift6)
...
try{
	var socket = io.connect('http://'+socketIOTarget,{
