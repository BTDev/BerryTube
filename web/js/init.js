...
var NOTIFY = new Audio(CDN_ORIGIN + "/sounds/notify.wav"); // buffers automatically when created
var DRINK = new Audio(CDN_ORIGIN + "/sounds/drink.wav"); // buffers automatically when created
var ATTENTION = new Audio(CDN_ORIGIN + "/sounds/attention.wav"); // [](/shift6)
