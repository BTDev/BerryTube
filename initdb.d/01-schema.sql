...
DROP TABLE IF EXISTS `giveaway_registration`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `giveaway_registration` (
  ...
  `confirmip` mediumtext NOT NULL,
  `verified` mediumtext NOT NULL,
...
DROP TABLE IF EXISTS `videos_PUSH`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videos_PUSH` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position` bigint(20) unsigned NOT NULL,
  `videoid` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `videotitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
DROP TABLE IF EXISTS `videos_bak`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videos_bak` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position` bigint(20) unsigned NOT NULL,
  `videoid` varchar(20) CHARACTER SET latin1 NOT NULL,
  `videotitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `videolength` int(11) NOT NULL,
  `videovia` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `videos_fool`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videos_fool` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position` bigint(20) unsigned NOT NULL,
  `videoid` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `videotitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
DROP TABLE IF EXISTS `videos_twoyear`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videos_twoyear` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position` bigint(20) unsigned NOT NULL,
  `videoid` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `videotitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
--
-- Table structure for table `videos_twoyear_new`
--

DROP TABLE IF EXISTS `videos_twoyear_new`;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `videos_twoyear_new` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `position` bigint(20) unsigned NOT NULL,
  `videoid` varchar(1000) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `videotitle` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
